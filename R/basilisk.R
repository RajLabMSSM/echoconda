...
#' \item{"channel" : }{Channel where the package was installde from.}
#' }
...
create_env_basilisk <- function(yaml_path,
    ...
    envObj <- basilisk::BasiliskEnvironment(
        ...
        packages = paste(nonpip_pkgs$package,nonpip_pkgs$version,sep="=="),
        pip = paste(pip_pkgs$package,pip_pkgs$version,sep="=="),
